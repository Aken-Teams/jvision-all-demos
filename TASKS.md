...
- [ ] Create or import the project under `demos/<repo>/`.
- [ ] Ensure it can run independently.
- [ ] Add catalog metadata to `projects-index.json`.
- [ ] Confirm the Hub route is `/demos/<repo>/`.
- [ ] Provide responsive layout, meaningful statistics and clear AI-enabled workflow content.
- [ ] Validate desktop, mobile and browser console state.
- [ ] Update `PROGRESS.md`, `CHANGELOG.md` and, if needed, `DECISIONS.md`.
