...
setupProjectPeopleModules({"id":1307,"name":"績效考核管理系統（PMS, Performance Management System）","description":"辦公室與幹部人員的目標設定、期中檢核、年度考核與評等管理，支援KPI/OKR多元制度。","modules":["績效總覽","目標設定","考核校準","AI 績效洞察"],"functions":["KPI/OKR目標設定與追蹤","主管/員工雙向考核表單","360度回饋評核","考核等第分佈與強制分配","考核結果與獎金/調薪連動","考核歷程歸檔查詢"],"workflows":["目標設定","期中檢核","自評","主管評核","校準會議","結果發佈與獎酬連結"],"pains":["紙本考核表流程冗長","考核標準各主管認知不一","考核結果與薪酬脫節","缺乏歷年績效趨勢分析"],"ai":["考核評語一致性與偏誤偵測","高潛力人才自動標記"],"roles":["人資部","各部門主管","高階經營層"],"metrics":["考核完成率","考核結果分佈合理度","目標達成率","申訴案件數"],"fields":["對象","期限","風險","負責人"]});
