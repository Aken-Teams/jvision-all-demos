...
setupProjectPeopleModules({"id":1306,"name":"教育訓練管理系統（LMS, Learning Management System）","description":"規劃並追蹤新人訓練、產線技能訓練、法規訓練與線上課程，建立員工能力發展紀錄。","modules":["課程總覽","課程與班級","學習紀錄","AI 學習建議"],"functions":["課程規劃與線上教材管理","新人訓練/OJT進度追蹤","產線技能認證與考核","法規必修課程（消防、職安）提醒","訓練時數統計與證書發放","講師與教室資源排程"],"workflows":["訓練需求規劃","課程排定","員工報名/指派","上課簽到","測驗考核","證書/紀錄歸檔"],"pains":["大量新進員工訓練進度難掌握","技能認證紙本紀錄易遺失","法規訓練逾期未察覺","訓練成效無法量化評估"],"ai":["AI課程推薦與個人化學習路徑","技能落差自動分析"],"roles":["人資訓練組","產線班組長","職安衛部門","品保部"],"metrics":["訓練完成率","技能認證通過率","法規逾期率","訓練投資報酬"],"fields":["對象","期限","風險","負責人"]});
