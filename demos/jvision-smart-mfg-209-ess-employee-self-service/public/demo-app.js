...
setupProjectPeopleModules({"id":1309,"name":"員工自助服務系統（ESS, Employee Self-Service）","description":"提供員工線上查詢薪資、請假、打卡異常申訴等自助功能，減少人資窗口重複性作業。","modules":["員工服務台","個人資料","申請與查詢","AI 員工助理"],"functions":["電子薪資單查詢","請假/加班線上申請","個人資料異動申請","出勤異常申訴","教育訓練報名","公司公告與問卷推播"],"workflows":["員工登入APP/Kiosk","選擇服務項目","線上申請","主管/HR簽核","結果通知"],"pains":["人資窗口大量重複性詢問","產線作業員紙本申請流程慢","員工資料更新不即時","多廠區員工服務資源不均"],"ai":["智慧客服機器人回覆常見問題","個人化訊息與提醒推播"],"roles":["全體員工","人資部","產線行政人員"],"metrics":["自助服務使用率","HR人工詢問件數下降率","申請處理時效","員工滿意度"],"fields":["對象","期限","風險","負責人"]});
