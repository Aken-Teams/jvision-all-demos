...
setupProjectPeopleModules({"id":1310,"name":"外籍移工管理系統（Foreign Worker Management）","description":"專為電子製造業大量聘僱外籍移工設計，管理入境、居留、體檢、契約與仲介費用等專屬事務。","modules":["移工總覽","證件效期","宿舍與工時","AI 合規提醒"],"functions":["聘僱許可與居留證到期提醒","入出境與體檢排程管理","仲介費用/服務費申報追蹤","多語言合約與公告發送","移工宿舍/交通安排連動","轉換雇主/轉出作業紀錄"],"workflows":["招募媒合","入境安排","聘僱許可申請","到職建檔","居留/體檢期限追蹤","期滿續聘或離境"],"pains":["聘僱許可與居留證逾期罰則風險","多國籍語言溝通障礙","移工異動作業流程繁瑣","仲介費用透明度不足易生爭議"],"ai":["證件到期自動預警提醒","多語言智慧翻譯溝通輔助"],"roles":["人資部","勞務仲介窗口","廠務行政","法務合規部"],"metrics":["證件逾期件數","聘僱合規率","移工留任率","仲介成本占比"],"fields":["對象","期限","風險","負責人"]});
