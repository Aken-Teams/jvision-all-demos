...
setupProjectPeopleModules({"id":1317,"name":"組織圖與職位管理系統（Org Chart & Position Management）","description":"視覺化呈現企業組織架構、職位編制與職缺配額，支援多廠區、多事業部的組織管理需求。","modules":["組織總覽","部門與職位","編制異動","AI 組織診斷"],"functions":["動態組織圖視覺化","職位編制與員額管控","職位說明書（JD）管理","職等職級與敘薪對應","組織異動模擬與版本比對","跨部門/跨廠區職位查詢"],"workflows":["組織調整申請","編制審核","組織圖更新","職位說明書同步","公告發佈","歷史版本歸檔"],"pains":["組織異動頻繁導致圖表未即時更新","職位編制超額未即時察覺","多事業部組織架構難以一目了然","職位說明書版本混亂"],"ai":["組織效能與管理幅度智慧分析","職位重疊/冗餘自動偵測"],"roles":["人資部","經營高層","各部門主管","財務部（人力成本）"],"metrics":["編制達成率","組織圖更新時效","職位空缺天數","管理幅度合理性"],"fields":["對象","期限","風險","負責人"]});
