...
setupProjectPeopleModules({"id":1301,"name":"HRIS（Human Resource Information System）","description":"企業人事主檔與組織資料的中央資料庫，作為所有人資子系統的資料來源與整合基礎。","modules":["人員主檔","組織與職位","人事異動","AI 人才洞察"],"functions":["員工基本資料與異動履歷管理","組織架構與職位對應","人事異動（調職、升遷、離職）簽核","證照/學經歷資料庫","多廠區/多法人資料整合","報表中心與人力儀表板"],"workflows":["員工到職建檔","異動申請","主管簽核","HR覆核","主檔更新","同步至薪資/考勤系統"],"pains":["各廠區人事資料分散、口徑不一","紙本異動單追蹤困難","集團多法人人力盤點耗時","缺乏即時人力結構分析"],"ai":["異常人事異動自動偵測","組織人力結構智慧分析建議"],"roles":["人資部","行政部","各部門主管","稽核部"],"metrics":["資料正確率","異動處理時效","系統資料完整度","跨廠資料同步率"],"fields":["對象","期限","風險","負責人"]});
