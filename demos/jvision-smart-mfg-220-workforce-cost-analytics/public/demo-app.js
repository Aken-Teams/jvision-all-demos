...
setupProjectPeopleModules({"id":1320,"name":"人力成本分析與人事報表系統（Workforce Cost Analytics）","description":"彙整薪資、加班、福利、招募等各項人力成本數據，提供經營層人力投資報酬與成本結構分析。","modules":["成本總覽","人力成本","預算與差異","AI 成本洞察"],"functions":["人力成本結構儀表板","部門/產線別人事費用分攤","加班費/外包費用趨勢分析","人均產值與人力投資報酬率","預算與實際人力成本比對","客製化人事報表產出"],"workflows":["各系統成本資料匯入","成本歸屬分攤","報表產出","主管檢視分析","預算調整建議","追蹤成效"],"pains":["人力成本數據分散於多系統難彙整","部門別成本歸屬不清","加班/外包費用暴增未即時掌握","人力預算與實際落差難追蹤"],"ai":["人力成本異常波動自動預警","成本結構最佳化模擬建議"],"roles":["人資部","財務部","經營高層","各廠區廠長"],"metrics":["人事費用率","人均產值","加班費占比","預算達成率"],"fields":["對象","期限","風險","負責人"]});
