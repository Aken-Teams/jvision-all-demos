...
setupProjectPeopleModules({"id":1318,"name":"新進員工報到管理系統（Onboarding Management）","description":"管理錄取員工自報到前準備到試用期滿的全流程，加速大量產線新人快速上線與融入。","modules":["報到總覽","報到任務","文件與訓練","AI 到職助理"],"functions":["報到前文件與體檢預約","到職手續電子化簽署","新人訓練排程自動指派","試用期考核追蹤","導師/夥伴制度配對","報到進度儀表板"],"workflows":["錄取通知","報到文件準備","到職手續辦理","新人訓練指派","試用期追蹤","轉正評核"],"pains":["大量新人同時到職手續紙本作業慢","試用期考核追蹤不易","新人流失多集中於到職前三個月","各部門報到準備事項未同步"],"ai":["新人早期離職風險預測","報到流程智慧提醒與待辦推播"],"roles":["人資部","產線用人主管","教育訓練組","廠務行政"],"metrics":["報到手續完成時效","試用期留任率","新人訓練完成率","轉正通過率"],"fields":["對象","期限","風險","負責人"]});
