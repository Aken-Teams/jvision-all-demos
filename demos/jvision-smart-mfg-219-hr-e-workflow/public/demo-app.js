...
setupProjectPeopleModules({"id":1319,"name":"人事電子簽核系統（HR e-Workflow）","description":"將請假、加班、異動、獎懲等各類人事申請單導入電子簽核流程，取代紙本簽呈提升效率與可追溯性。","modules":["簽核總覽","待辦申請","簽核流程","AI 簽核摘要"],"functions":["表單流程設計器（可視化簽核路徑）","多層級簽核與代理人設定","行動裝置簽核推播","簽核歷程與時間戳記存證","跨系統表單資料串接","簽核逾期提醒"],"workflows":["員工提出申請","系統依規則轉送簽核","主管/HR逐層審核","簽核完成通知","資料同步至相關系統"],"pains":["紙本簽呈流程冗長且易遺失","主管出差無法即時簽核","簽核歷程無法稽核追溯","各類人事表單分散難統一管理"],"ai":["簽核路徑異常/卡關自動偵測","智慧表單自動填單建議"],"roles":["人資部","全體主管與員工","稽核部","資訊部"],"metrics":["平均簽核時效","逾期簽核件數","電子化比率","系統使用率"],"fields":["對象","期限","風險","負責人"]});
