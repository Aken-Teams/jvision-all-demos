...
const projectName = "Jvision 拖吊派遣與車隊管理平台";
const slug = "jvision-towing-dispatch";
const demoUrl = process.env.DEMO_URL || "https://jvision-towing-dispatch.vercel.app";
const outDir = "D:/code/image/說明文件/Jvision 拖吊派遣與車隊管理平台";
...
<svg width="1080" height="1530" viewBox="0 0 1080 1530" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="140" y="270" fill="#59d3ff" font-size="28" font-family="Arial, Microsoft JhengHei" font-weight="800">Jvision Towing Dispatch</text>
  <text x="140" y="334" fill="#ffffff" font-size="54" font-family="Arial, Microsoft JhengHei" font-weight="900">拖吊派遣與車隊管理平台</text>
  <text x="108" y="470" fill="#182231" font-size="38" font-family="Arial, Microsoft JhengHei" font-weight="900">派遣、車隊、保管與收款一次掌握</text>
  <text x="108" y="528" fill="#5d6c81" font-size="25" font-family="Arial, Microsoft JhengHei">完整 Demo 可新增救援任務、指派車輛、更新帳務並生成 AI 摘要。</text>
  ...
  <text x="185" y="718" fill="#1d65f2" font-size="28" font-family="Arial, Microsoft JhengHei" font-weight="900">接單派遣</text>
  <text x="185" y="768" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">來電建檔</text>
  <text x="185" y="805" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">司機指派</text>
  <text x="470" y="718" fill="#ff7a2f" font-size="28" font-family="Arial, Microsoft JhengHei" font-weight="900">車隊狀態</text>
  <text x="470" y="768" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">出勤追蹤</text>
  <text x="470" y="805" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">保養提醒</text>
  <text x="755" y="718" fill="#0ea5b7" font-size="28" font-family="Arial, Microsoft JhengHei" font-weight="900">帳務收款</text>
  <text x="755" y="768" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">開單狀態</text>
  <text x="755" y="805" fill="#182231" font-size="22" font-family="Arial, Microsoft JhengHei">應收追蹤</text>
  ...
  <text x="108" y="1394" fill="#5d6c81" font-size="24" font-family="Arial, Microsoft JhengHei">讓調度、司機、保管場與帳務同步掌握每一件任務。</text>
</svg>`;
...
await makePdf(posterPdfPath, projectName, "Cloud dispatch demo for towing, roadside assistance, impound operations and billing.", [
  "Dispatch roadside assistance and towing calls",
  "Assign drivers and trucks with live status",
  "Track task progress from call intake to completion",
  "Manage impound and billing follow-up",
  "Generate AI operation summaries for dispatch teams",
]);

await makePdf(introPdfPath, `${projectName} 產品介紹`, "A practical Jvision demo for towing operators, dispatchers, drivers, impound yards and accounting teams.", [
  "Create service calls and assign nearby trucks",
  "Keep dispatch, drivers and office teams aligned",
  "Track vehicle availability and task progress",
  "Update invoices, payments and receivables",
]);
