...
setupProjectPeopleModules({"id":1305,"name":"招募管理系統（ATS, Applicant Tracking System）","description":"管理職缺公告、履歷篩選、面試安排至錄取全流程，因應製造業大量產線作業員快速招募需求。","modules":["招募總覽","職缺管理","候選人流程","AI 履歷媒合"],"functions":["多平台職缺同步刊登","履歷自動篩選與關鍵字比對","面試排程與線上通知","錄取核薪簽核流程","人才庫建立與再利用","招募成效報表"],"workflows":["職缺申請","刊登發佈","履歷篩選","面試安排","錄取核薪","轉入職管理"],"pains":["產線缺工需大量快速招募","履歷分散於多平台難以彙整","面試安排人工協調耗時","招募來源成效無法量化"],"ai":["AI履歷自動評分與職缺媒合","到職率/流失風險預測"],"roles":["人資招募組","用人部門主管","廠務行政"],"metrics":["職缺補齊天數","履歷轉面試率","錄取到職率","招募成本"],"fields":["對象","期限","風險","負責人"]});
