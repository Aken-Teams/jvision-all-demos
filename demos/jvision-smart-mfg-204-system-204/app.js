...
setupProjectPeopleModules({"id":1304,"name":"產線排班管理系統（三班制排班）","description":"針對SMT/PCB/半導體產線二班制或三班制輪班需求，進行人力排班、換班與加班安排的專業排班工具。","modules":["班表總覽","班次配置","換班申請","AI 智慧排班"],"functions":["三班制/四班二輪排班規則引擎","產線人力配置與技能對應","換班/代班申請與審核","加班需求預估與派工","排班衝突自動檢核","假日班表與連假排班"],"workflows":["產能需求輸入","人力技能比對","自動排班","主管調整","員工確認","班表發佈"],"pains":["手工排班耗時且易疏漏技能配對","頻繁換班導致產線缺工","連續夜班疲勞未受控管","法定工時上限難以人工掌控"],"ai":["AI智慧排班最佳化演算法","疲勞風險與缺工預測預警"],"roles":["產線主管","生產排程部","人資部","各班組長"],"metrics":["排班達成率","換班申請處理時效","缺工率","超時工作占比"],"fields":["對象","期限","風險","負責人"]});
