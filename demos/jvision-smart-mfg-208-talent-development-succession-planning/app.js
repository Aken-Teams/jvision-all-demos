...
setupProjectPeopleModules({"id":1308,"name":"人才發展與繼任計畫系統（Talent Development & Succession Planning）","description":"針對關鍵技術職位與幹部職缺，規劃人才梯隊與接班培育計畫，降低關鍵人力斷層風險。","modules":["人才總覽","職能盤點","繼任梯隊","AI 發展建議"],"functions":["關鍵職位盤點與風險評估","高潛力人才九宮格分析","個人發展計畫（IDP）追蹤","繼任候選人資料庫","技能矩陣與職涯路徑規劃","人才盤點會議紀錄管理"],"workflows":["關鍵職位盤點","候選人評估","九宮格定位","發展計畫擬定","導師輔導","繼任準備度追蹤"],"pains":["資深技術幹部退休斷層風險","缺乏系統化接班梯隊","高潛力人才流失未及早介入","人才盤點仰賴口耳相傳"],"ai":["高潛力人才預測模型","繼任準備度自動評分"],"roles":["人資部","高階經營層","各廠區處長級主管"],"metrics":["關鍵職位繼任覆蓋率","高潛人才留任率","發展計畫完成率","完成率"],"fields":["對象","期限","風險","負責人"]});
