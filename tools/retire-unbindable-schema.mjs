 ...
 * （畫面上有幾張表、幾個畫面）。日後那些 demo 補上表格時要能還原。
 *
 *   node tools/retire-unbindable-schema.mjs [--dry-run] [--restore]
 */
...
const targets = audit.rows.filter((r) => r.kind === "畫面沒有表格");
if (!targets.length) { log.warn("盤點裡沒有這一類"); process.exit(EXIT.OK); }
