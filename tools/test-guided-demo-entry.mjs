...
const version = "20260810-guided-4";
...
for (const project of catalog.projects) {
  ...
  assert.ok(html.includes(`jvision-client-demo.css?v=${version}`), `${project.repoName} has a stale guided-entry stylesheet`);
  assert.ok(html.includes(`jvision-client-demo.js?v=${version}`), `${project.repoName} has a stale guided-entry runtime`);
