...
完整原始碼在 public/index.html（就在你的工作目錄底下），需要細節時自己去讀。
...
真的去讀 public/index.html，找找看有沒有既有的頭像、選單、彈出層、篩選器、
狀態標籤、統計卡——名字可能不一樣（avatar / user / profile / menu / dropdown /
popover / chip / badge），但做的是同一件事。
