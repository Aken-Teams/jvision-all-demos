...
## 一致性檢查
- 依 經營管理 情境運用「一致性檢查」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。

## 驗收基線
- 依 經營管理 情境運用「驗收基線」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。

## 回歸把關
- 依 經營管理 情境運用「回歸把關」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。
