...
## 線框草稿
- 依 生產製造 情境運用「線框草稿」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。
...
## 設計 tokens
- 依 生產製造 情境運用「設計 tokens」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。

## 可用性檢視
- 依 生產製造 情境運用「可用性檢視」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。
