...
## 問答協助
- 依 研發管理 情境運用「問答協助」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。

## 流程引導
- 依 研發管理 情境運用「流程引導」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。
...
## 任務代辦
- 依 研發管理 情境運用「任務代辦」，遵守 dataMode：reasoning（詳見 ../../datamodes/reasoning.md）。
